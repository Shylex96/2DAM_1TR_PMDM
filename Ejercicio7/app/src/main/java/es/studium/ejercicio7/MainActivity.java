...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        EditText placeholder = findViewById(R.id.editTextTextMultiLine);
        texto = String.valueOf(placeholder.getText());
        ...
        if (contador == 0) {
            ...
            Toast.makeText(MainActivity.this, ""+contador, Toast.LENGTH_SHORT).show();
        }
    }
